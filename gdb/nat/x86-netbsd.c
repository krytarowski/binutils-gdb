...
#include "x86-netbsd.h"
#include "x86-netbsd-dregs.h"
...
void
x86_netbsd_new_thread (struct lwp_info *lwp)
{
...
void
x86_netbsd_delete_thread (struct arch_lwp_info *arch_lwp)
{
  xfree (arch_lwp);
}
...
void
x86_netbsd_prepare_to_resume (struct lwp_info *lwp)
{
  x86_netbsd_update_debug_registers (lwp);
}
